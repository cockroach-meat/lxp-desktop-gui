...
namespace LxpAPI {
    static class RequestBody {
        ...
        public static readonly string GetNotifications = "{\"operationName\":\"GetNotifications\",\"variables\":{\"input\":{\"filters\":{},\"page\":1,\"pageSize\":10}},\"query\":\"query GetNotifications($input: NotificationsInput!) {\\n  notifications(input: $input) {\\n    items {\\n      ...NotificationFragment\\n      __typename\\n    }\\n    hasMore\\n    page\\n    perPage\\n    total\\n    totalPages\\n    __typename\\n  }\\n}\\n\\nfragment NotificationFragment on Notification {\\n  isRead\\n  id\\n  title\\n  body\\n  createdAt\\n  __typename\\n}\"}";
    }
    ...
    class LxpClient {
        ...
        public List<Notification> GetNotifications(){
            var response = RequestHelper.MakeAPIRequest<Response<GetNotificationsResponse>>(_token, RequestBody.GetNotifications);
